...
(1) 誤字
(2) 文脈的に記載内容が明確に間違っていて、誤解を与える場合
(3) 文法が致命的に間違っていて、誤解を与える場合

ただし、以下の項目については指摘しないでください:
(1) 偽陽性を避けるため、判断に迷った場合は指摘しない
(2) 不自然な改行や空白については、指摘しない
(3) 文章口語のように省略されていても、意味が伝わるなら指摘しない
(4) カタカナ語の長音符については独自ルールがあるため指摘しない。例：バッテリ、モータ
